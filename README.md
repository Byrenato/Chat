-- [1] Configuração da Key
local HttpService = game:GetService("HttpService")
local keyRequired = "KEY_719292929282727272839393" -- A key que você definiu
local userKey = ""

-- [2] Exibir mensagem para o usuário acessar o link e obter a key
print("Para usar este script, obtenha a key em: https://direct-link.net/1253113/key-script")

-- [3] Função para solicitar a key do usuário
repeat
    print("Por favor, insira a key que você obteve:")
    userKey = io.read() -- Solicita input do usuário no console

    -- Verificação da key inserida
    if userKey ~= keyRequired then
        print("Key inválida! Tente novamente.")
        wait(2) -- Pausa para evitar spam de tentativas
    end
until userKey == keyRequired

print("Key válida! Acesso permitido. Executando script...")

-- [4] Aqui começa o resto do seu script
-- Insira suas funcionalidades abaixo desta linha
